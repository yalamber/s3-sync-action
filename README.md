# GitHub Action to Sync to multiple S3 Bucket 🔄

This simple action uses the [vanilla AWS CLI](https://docs.aws.amazon.com/cli/index.html) to sync a directory (either from your repository or generated during your workflow) with a multiple remote S3 bucket.
...
| `AWS_S3_BUCKET` | The name of the multiple bucket you're syncing to separate with comma. For example, `jarv.is,test-bucket,bucket-two` or `app-web,my-app-releases`. | `secret env` | **Yes** | N/A |
